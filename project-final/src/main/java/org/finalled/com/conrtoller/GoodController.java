...
public class GoodController 
{
	...
	/*
	 * @RequestMapping("/goods_vehicle_list.php") public Map<String,
	 * List<GoodsVehicle>> getGoods() throws JsonProcessingException { Map<String,
	 * List<GoodsVehicle>> usersMap = new HashMap<String, List<GoodsVehicle>>();
	 * 
	 ...
	 */
			 ...
			 public Map<String, Object> getGoods() {
			  List<GoodsVehicle> bookings = goodService.getGoods();
	 ...
	 */
	  ...
	  good.setStatus("1"); 
		/*
		 * good.setPostId(good.getPostId()); good.setUserId(good.getUserId());
		 * good.setVehicleId(good.getVehicleId());
		 */
