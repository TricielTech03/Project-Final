...
public class UserController {
 ...
 public ModelAndView login() {
  ...
  model.addObject("User login succesful");
...
//Rest api method to get all users details
	 ...
	 * createUser(@RequestBody User user) { userService.addUser(user); }
	 */
	...
	/*
	 ...
	 public Map<String, List<userDetailsDTO>> findUserByUserName(@Param(value = "email") String email, @Param(value = "password") String password,@Param(value = "user_id") Long id, @Param(value = "usertype") String usertype) throws JsonProcessingException 
		{
		 Map<String, List<userDetailsDTO>> usersMap = new HashMap<String, List<userDetailsDTO>>();
		  List<userDetailsDTO> Users = userService.findUserByUserName(email,password,id,usertype);
